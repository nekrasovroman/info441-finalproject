...
| -------- | ------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0       | As a user          | I want to be able to create an account and log in so I can access the application securely.    | Implement authentication using a backend REST API. User credentials are validated on login and a session or unique ID token is issued. User records are stored in the database. |
